...
public class FastCash extends JFrame implements ActionListener{
    ...
    FastCash(String pinnumber){
        ...
        withdrawl.setBounds(352,415,150,30);
        ...
        ministatement.setBounds(352,450,150,30);
        ...
        balanceenquiry.setBounds(352,485,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== back){
            ...
            conn cz= new conn();
            try{
                ResultSet rs=cz.s.executeQuery("select * from bank where pin = '"+pinnumber+"'");
                int balance=0;
                while(rs.next()){
